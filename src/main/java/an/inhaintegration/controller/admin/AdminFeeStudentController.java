...
import an.inhaintegration.service.ExcelService;
import an.inhaintegration.service.admin.AdminStudentService;
...
public class AdminFeeStudentController {
    ...
    public String deleteFeeStudents(@RequestParam("stuIdList") List<String> stuIdList) {
        ...
        System.out.println("stuIdList.size() = " + stuIdList.size());
