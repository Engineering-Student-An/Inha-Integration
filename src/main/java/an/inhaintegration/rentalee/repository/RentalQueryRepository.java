...
public class RentalQueryRepository {
    ...
    public Page<Rental> findByStuIdAndStatusAndItemName(RentalSearchRequestDto rentalSearchRequestDto, Pageable pageable) {
        ...
        List<Rental> results = query.select(rental)
                ...
                .where(stuIdLike(rentalSearchRequestDto.getStuId()), statusEq(rentalSearchRequestDto.getRentalStatus()), itemNameLike(rentalSearchRequestDto.getItemName()))
        ...
        long total = query.selectFrom(rental)
                ...
                .where(
                        stuIdLike(rentalSearchRequestDto.getStuId()),
                        statusEq(rentalSearchRequestDto.getRentalStatus()),
                        itemNameLike(rentalSearchRequestDto.getItemName())
                )
                .fetchCount();
